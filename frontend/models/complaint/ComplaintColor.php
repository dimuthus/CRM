...
/**
 * This is the model class for table "complaint_color".
 *
 * @property integer $id
 ...
 */
class ComplaintColor extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['created_by', 'deleted', 'devision_id', 'brand_id', 'subband_id', 'product_id'], 'integer'],
