...
class ReportController extends Controller
{
 ...
 public function actionGenerateSummaryOutbound()
	...
	public function actionDailyupdates()
    {
        $searchModel = new ReportSearch();
        ...
        return $this->render('dailyupdates', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider
        ]);
    }
    
	public function actionGenerateDailyupdates()
    {
        $params =Yii::$app->request->queryParams;

        $searchModel = new ReportSearch();
        $results = $searchModel->generateDailyupdates($params);

        return $this->renderAjax('dailyupdates_result', [
            'dataProvider' => $results,
        ]);
