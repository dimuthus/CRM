...
<div class="agegroup-index">
    ...
    <?php $form = ActiveForm::begin(['id' => 'dropdown-agegroup-form']); ?>
    ...
    <div id="agegroup-widget">
        <?= $this->render(Url::to('age_group_list'), [
...
<?php
    $this->registerJs("
        ...
        $('#dropdown-agegroup-form').submit(function (e) {
            e.preventDefault();
            e.stopImmediatePropagation();
            addDropdownValue($(this),'agegroup');
            return false;
        });
