...
<div class="case-type-index">
    ...
    <?php $form = ActiveForm::begin(['id' => 'dropdown-case-type-form']); ?>
    ...
    <div id="case-type-widget">
        <?= $this->render(Url::to('case_type_list'), [
...
<?php
    $this->registerJs("
        ...
        $('#dropdown-case-type-form').submit(function (e) {
            e.preventDefault();
            e.stopImmediatePropagation();
            addDropdownValue($(this),'case_type');
            return false;
        });
