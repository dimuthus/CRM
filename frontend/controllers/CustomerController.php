...
//uploader code ends here....
    ...
    public function actionGetcustomerybymrn($mrn) {
        ...
        if (count($result) > 0) {
            ...
            return $this->redirect(['view', 'id' => $model->id, 'jmc' => $hashID,'CallId'=>123654]);
         } else {
              return $this->redirect(['create', 'model' => $model,'jmc' => $hashID,'CallId'=>123654]);
         }
