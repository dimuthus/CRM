...
$sub_title = 'Service Request Device Types';
/*$this->params['breadcrumbs'][] = $this->title;*/
?>
<div class="request-device-type-index">

    <h4><?= $sub_title ?></h4>

    <?php $form = ActiveForm::begin(['id' => 'dropdown-request-device-type-form']); ?>
    ...
    <div id="request-device-type-widget">
        <?= $this->render(Url::to('request_device_type_list'), [
...
<?php
    $this->registerJs("
        ...
        $('#dropdown-request-device-type-form').submit(function (e) {
            e.preventDefault();
            e.stopImmediatePropagation();
            addDropdownValue($(this),'request_device_type');
            return false;
        });
