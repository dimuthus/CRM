...
<?php \yii\widgets\Pjax::begin(['id' => 'request_enhancement_category','enablePushState'=>FALSE,'timeout' => 10000, 'clientOptions' => ['container' => 'pjax-container']]); ?>
                                    ...
                                    'pluginEvents'=> [
                                        'switchChange.bootstrapSwitch' => 
                                            'function(event, state) { 
                                                toggleDeleted(state, "'.Url::to(['/tools/dropdown/request-enhancement-category',
                                                                                        'id' => $model->id,
                                                                                        'hasToggle'=>true
                                                                                        ]).'"); 
                                            }',
