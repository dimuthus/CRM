...
$sub_title = 'Complaint Division';
/*$this->params['breadcrumbs'][] = $this->title;*/
?>
<div class="complaint-division-index">

    <h4><?= $sub_title ?></h4>

    <?php $form = ActiveForm::begin(['id' => 'dropdown-complaint-division-form']); ?>
    ...
    <div id="contact-type-widget">
        <?= $this->render(Url::to('complaint_division_list'), [
...
<?php
    $this->registerJs("
        ...
        $('#dropdown-complaint-division-form').submit(function (e) {
            e.preventDefault();
            e.stopImmediatePropagation();
            addDropdownValue($(this),'complaint-division');
            return false;
        });
