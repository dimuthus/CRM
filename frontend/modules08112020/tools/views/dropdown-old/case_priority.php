...
<div class="case-priority-index">
    ...
    <?php $form = ActiveForm::begin(['id' => 'dropdown-case-priority-form']); ?>
    ...
    <div id="case-priority-widget">
        <?= $this->render(Url::to('case_priority_list'), [
...
<?php
    $this->registerJs("
        ...
        $('#dropdown-case-priority-form').submit(function (e) {
            e.preventDefault();
            e.stopImmediatePropagation();
            addDropdownValue($(this),'case_priority');
            return false;
        });
