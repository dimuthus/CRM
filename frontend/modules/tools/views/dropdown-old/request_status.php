...
$sub_title = 'Service Request Statuses';
...
<div class="request-status-index">
    ...
    <?php $form = ActiveForm::begin(['id' => 'dropdown-request-status-form']); ?>
    ...
    <div id="request-status-widget">
        <?= $this->render(Url::to('request_status_list'), [
...
<?php
    $this->registerJs("
        ...
        $('#dropdown-request-status-form').submit(function (e) {
            e.preventDefault();
            e.stopImmediatePropagation();
            addDropdownValue($(this),'request_status');
            return false;
        });
