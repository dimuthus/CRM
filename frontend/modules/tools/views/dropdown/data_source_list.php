...
<?php \yii\widgets\Pjax::begin(['id' => 'datasource','enablePushState'=>FALSE,'timeout' => 10000, 'clientOptions' => ['container' => 'pjax-container']]); ?>
                                    ...
                                    'pluginEvents'=> [
                                        'switchChange.bootstrapSwitch' =>
                                            'function(event, state) {
                                                toggleDeleted(state, "'.Url::to(['/tools/dropdown/data-source',
                                                                                        'id' => $model->id,
                                                                                        'hasToggle'=>true
                                                                                        ]).'");
                                            }',
