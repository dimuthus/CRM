...
$sub_title = 'Service Request Types';
...
<div class="request-type-index">
    ...
    <?php $form = ActiveForm::begin(['id' => 'dropdown-request-type-form']); ?>
    ...
    <div id="request-type-widget">
        <?= $this->render(Url::to('request_type_list'), [
...
<?php
    $this->registerJs("
        ...
        $('#dropdown-request-type-form').submit(function (e) {
            e.preventDefault();
            e.stopImmediatePropagation();
            addDropdownValue($(this),'request_type');
            return false;
        });
