...
<div class="product-category-index">
    ...
    <?php $form = ActiveForm::begin(['id' => 'dropdown-product-category-form']); ?>
    ...
    <div id="product-category-widget">
        <?= $this->render(Url::to('product_category_list'), [
...
<?php
    $this->registerJs("
        ...
        $('#dropdown-product-category-form').submit(function (e) {
            e.preventDefault();
            e.stopImmediatePropagation();
            addDropdownValue($(this),'product_category');
            return false;
        });
