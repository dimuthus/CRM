...
class InboundInteractionController extends Controller
{
    ...
    {
		$inbInModel=$this->findModel($id);
			$logmodel= new Logadm();
            $data = array('interaction_id' => $inbInModel['inbound_interaction_id']);
            $data=json_encode($data);
            $logmodel->createViewLog("Interaction:View",$data);
