...
/**
 * This is the model class for table "complaint_subbrand".
 *
 * @property integer $id
 ...
 */
class ComplaintSubBrand extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['created_by', 'deleted', 'devision_id', 'brand_id'], 'integer'],
