...
$sub_title = 'Caller Type';
/*$this->params['breadcrumbs'][] = $this->title;*/
?>
<div class="callertype-index">

    <h4><?= $sub_title ?></h4>

    <?php $form = ActiveForm::begin(['id' => 'dropdown-callertype-form']); ?>
    ...
    <div id="callertype-widget">
        <?= $this->render(Url::to('callertype_list'), [
...
<?php
    $this->registerJs("
        ...
        $('#dropdown-callertype-form').submit(function (e) {
            e.preventDefault();
            e.stopImmediatePropagation();
            addDropdownValue($(this),'callertype');
            return false;
        });
