...
<?php \yii\widgets\Pjax::begin(['id' => 'productreplacementstatus','enablePushState'=>FALSE,'timeout' => 10000, 'clientOptions' => ['container' => 'pjax-container']]); ?>
                                    ...
                                    'pluginEvents'=> [
                                        'switchChange.bootstrapSwitch' =>
                                            'function(event, state) {
                                                toggleDeleted(state, "'.Url::to(['/tools/dropdown/product-replacement-status',
                                                                                        'id' => $model->id,
                                                                                        'hasToggle'=>true
                                                                                        ]).'");
                                            }',
