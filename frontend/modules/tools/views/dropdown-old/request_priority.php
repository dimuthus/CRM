...
$sub_title = 'Service Request Priorities';
/*$this->params['breadcrumbs'][] = $this->title;*/
?>
<div class="request-priority-index">

    <h4><?= $sub_title ?></h4>

    <?php $form = ActiveForm::begin(['id' => 'dropdown-request-priority-form']); ?>
    ...
    <div id="request-priority-widget">
        <?= $this->render(Url::to('request_priority_list'), [
...
<?php
    $this->registerJs("
        ...
        $('#dropdown-request-priority-form').submit(function (e) {
            e.preventDefault();
            e.stopImmediatePropagation();
            addDropdownValue($(this),'request_priority');
            return false;
        });
