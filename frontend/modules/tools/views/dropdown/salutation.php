...
<div class="salutation-index">
  ...
  <div class="panel panel-info" style="margin-top: 20px;">
    ...
    <?php $form = ActiveForm::begin(['id' => 'dropdown-salutation-form']); ?>
    ...
    <div id="salutation-widget">
        <?= $this->render(Url::to('salutation_list'), [
...
<?php
    $this->registerJs("
        ...
        $('#dropdown-salutation-form').submit(function (e) {
            e.preventDefault();
            e.stopImmediatePropagation();
            addDropdownValue($(this),'salutation');
            return false;
        });
