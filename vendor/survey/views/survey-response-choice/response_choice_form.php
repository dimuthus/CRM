 ...
 <?php $form = ActiveForm::begin(['id' => 'survey-response-choice-form' ]); ?>  
    ...
    <div id="survey-response-choice-box" style="display:none">
        ...
        <table class="dropdown-form">
            <tr>
                <td><?= $form->field($model, 'text')->textInput(['maxlength' => 250, 'placeholder'=>'New Item'])->label(false)->error(false) ?></td>
                <td>
    ...
    <?php ActiveForm::end(); ?>
     ...
     <div id="survey-response-choice-widget">
            <?= $this->render(Url::to('/survey-response-choice/response_choice_list'), [
    ...
    $this->registerJs("
      ...
      //// alert('sss');
         ...
         $('#survey-response-choice-form').submit(function (e) {
                     var opText=$('#crmsurveyresponsechoice-text').val();

                if (opText==''){
                     $('.field-crmsurveyresponsechoice-text').addClass('has-error');
                    return false;
            ...
            //alert('callin fuction form page');
