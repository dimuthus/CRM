...
class InboundDetails extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['Description_Issue_Resolution'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'outcome_code_4' => 'Outcome Code 4',
            'outcome_code_5' => 'Outcome Code 5',
            'Description_Issue_Resolution' => 'Description Issue Resolution',
