...
use Yii;
/**
 * This is the model class for table "customer_language".
 *
 * @property integer $id
...
class CustomerLanguage extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(Customer::className(), ['preferred_language' => 'id']);
    }
}
