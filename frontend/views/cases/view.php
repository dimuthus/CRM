...
<div class="cases-view">
   ...
   <?php   if(Yii::$app->user->can('Update Service Request')) { ?>
        <?= Html::button('<span class="glyphicon glyphicon-pencil"></span> Update', ['value'=>Url::to(['cases/update','id' => $model->id ,'campaign_id'=>$campaign_id]),
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            'case_note',
			['attribute'=>'case_note','format' => 'raw',],
...
//            'calledFrom.name',
			            ...
			            ['attribute'=>'created_datetime','label'=>'Created Date Time'],
