...
<div class="customer-create_form">
    ...
    $form = ActiveForm::begin(); ?>
	  ...
	  <div class="row">
	  <div class="col-sm-4">
	    <?= $form->field($model, 'salutation_id')->dropDownList(
            ArrayHelper::map(Salutation::find()->where('deleted != :id', ['id'=>1])->orderBy('name')->all(), 'id', 'name'),
            ['prompt'=>'--------']
        );
    ?>
	   </div>
	  ...
	  <div class="row">
	  <div class="col-sm-4"> <?= $form->field($model, 'gender')->dropDownlist(
     ...
     <div class="row">
	  ...
	  <div class="row">
              <div class="col-sm-4"><?= $form->field($model, 't_pin')->passwordInput() ?>
         </div>
	  ...
	  <div class="row">
	  <div class="col-sm-4"><?= $form->field($model, 'mobile_number') ?></div>
	  <div class="col-sm-4"><?= $form->field($model, 'alternative_number') ?></div>
	  ...
	  <div class="col-sm-4"><?= $form->field($model, 'relationship_manager') ?></div>
	   ...
	   <div class="row">
	  <div class="col-sm-4"><?= $form->field($model, 'customer_status')->dropDownList(
            ArrayHelper::map(CustomerStatus::find()->where('deleted != :id', ['id'=>1])->orderBy('name')->all(), 'id', 'name'),
            ['prompt'=>'--------']
        ); ?></div>
	  <div class="col-sm-4"><?= $form->field($model, 'customer_type')->dropDownList(
            ArrayHelper::map(CustomerType::find()->where('deleted != :id', ['id'=>1])->orderBy('name')->all(), 'id', 'name'),
            ['prompt'=>'--------']
        ); ?>
	  </div>
	  ...
	  <div class="col-sm-4"><?= $form->field($model, 'cif') ?></div>
