  ...
  public function generateActivitylog($params)
    {
        ...
        $query->andFilterWhere(['between', 'dml_timestamp', $this->FromDate,$this->ToDate]);
...
public function generateDailyupdates($params)
    {
        $query = new Query;
		$query->select('*')->from('remoteuploaderlog');
        $this->load($params);
        ...
        $query->andFilterWhere(['between', 'datetime', $this->FromDate,$this->ToDate]);
